...
```bash
curl -O https://raw.githubusercontent.com/majortom69/dvpn-wireguard-install/refs/heads/master/wireguard-install.sh
...
The following Bash script adds a new user `foo` to an existing Wiregurad configuration
